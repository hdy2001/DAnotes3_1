...
public class AuthSender {
	public static void main(String[] args) throws Exception {
		 ...
		 *	其中\r\n为回车符,每个命今都必需以它们结尾. */
		// TODO: 3.填入命令
		command = "Helo hdy19@mails.tsinghua.edu.cn\r\n";		
		...
		String username = "hdy19@mails.tsinghua.edu.cn";
		...
		String password = "15281763765hdy";
		...
		command = "MAIL FROM:<hdy19@mails.tsinghua.edu.cn>\r\n";
		System.out.print(command);
		os.write(command.getBytes("US-ASCII"));
		response = br.readLine();
		System.out.println(response);
		...
		command = "RCPT TO:<2322766243@qq.com>\r\n";
		System.out.print(command);
		os.write(command.getBytes("US-ASCII"));
		response = br.readLine();
		System.out.println(response);
